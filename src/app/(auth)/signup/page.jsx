...
    // --- 3. Email check (FIXED) ---
    // This now matches your backend validation
    if (!email.endsWith('_be25@thapar.edu')) {
      return setError('Invalid Email. You must use your "_be25@thapar.edu" email address.');
    }

    // --- 4. Phone Number check (FIXED) ---
    const phoneRegex = /^[6-9]\d{9}$/;
    if (!phoneRegex.test(phoneNumber)) {
      return setError('Invalid Phone Number. Must be 10 digits and start with 6, 7, 8, or 9.');
    }
